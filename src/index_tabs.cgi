...
our $return = &this_url();
our @return1 = [	&this_url(), $text{'tab_main'}	];
...
print '<script type="text/javascript">
			...
			function addItVar(e) {
				...
				tr.id = "row_sel_";
				tr.bgcolor = "#f5f5f5";
				tr.class = "row0 ui_checked_columns mainbody";
				tr.onMouseOver="this.className = document.getElementById(\'sel_GRUB_DISABLE_SUBMENU\').checked ? \'mainhighsel\' : \'mainhigh\'";
				tr.onMouseOut="this.className = document.getElementById(\'sel_GRUB_DISABLE_SUBMENU\').checked ? \'mainsel\' : \'mainbody row0\'";
				...
				input.type="checkbox";
				input.name="sel";
				input.value="GRUB_DISABLE_SUBMENU";
				input.id="sel_GRUB_DISABLE_SUBMENU";
				input.onClick="document.getElementById(\'row_sel_GRUB_DISABLE_SUBMENU\').className = this.checked ? \'mainhighsel\' : \'mainhigh\';";
				var td2 = document.createElement("td");
				var label = document.createElement("label");
				labal.for="sel_GRUB_DISABLE_SUBMENU";
				var span = document.createElement("span");
				span.title="Set true to disable submenu branches.";
				span.innerHTML="";
				var td3 = document.createElement("td");
				var label2 = document.createElement("label");
				label2.for="sel_GRUB_DISABLE_SUBMENU";
				label2.innerHTML="";
				/*var td = document.createElement("td");*/
				opt.value = myval;
				opt.innerHTML = myval;
			...
			var addBtn = document.getElementById("newvar_submit");
			if (addBtn) {
				if (addBtn.addEventListener) {	addBtn.addEventListener("click", addItVar, false);
				} else if (addBtn.attachEvent) {	addBtn.attachEvent("onclick", addItVar);	}
			}
	...
	print &ui_table_row (	$text{'env_newvar'},
							'<div id="new_btn">'.
							...
							'<div id="new_box" style="visibility: hidden">'.
								...
								&ui_button ($text{'newvar_submit'}, "newvar_submit", 0).
